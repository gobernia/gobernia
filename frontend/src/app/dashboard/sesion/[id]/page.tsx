                ...
                <div className="border border-gray-100 rounded-2xl p-16 flex flex-col items-center text-center space-y-7">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-400 max-w-sm leading-relaxed">
                      Los 4 agentes revisarán tu perfil y generarán un diagnóstico completo
                      con hallazgos, alertas y recomendaciones.
                    </p>
                  </div>
                  ...
                  <button
                    onClick={runAnalysis}
                    disabled={analysing}
                    className="inline-flex items-center gap-2 bg-black text-white text-sm font-medium px-6 py-3 rounded-xl hover:bg-gray-900 transition-colors disabled:opacity-50"
                  >
                    {analysing
